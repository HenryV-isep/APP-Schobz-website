...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="styleRechercher.css">
...
<div class="topbar">
    ...
    <span class="menuduhautpartiegauche"> <!-- span c'est pour aligner les liens -->
        ...
        <a href="../Profil%20utilisateur/Profil%20utilisateur%20Apercu%20du%20compte.html">Mon compte</a>
        <a href="../A%20propos%20de%20nous/A%20propos%20de%20nous.html">A propos de nous</a>
    </span>
    <span>
        ...
        <div id="popupCGU" class="overlay">
            <div class="popup">
                ...
                <span class="content">
                    ...
                    Le site ‘driverpsychotechniquetest.fr’ est édité par la société SCHOBZ Corporation. Capital social de 60 euros, dont le siège social est situé 10 rue de vanves, 92130 Issy-les-moulineaux
 <br/><br/>
                    <b>Responsable de rédaction :</b><br/><br/>
                    Groupe SHORBZ <br/><br/>

                    <b>Hébergeur :</b><br/><br/>Le site ‘driverpsychotechniquetest.fr’ est hébergé par la société ISEP Paris
...
Afin de l’exercer, il suffit de nous en faire la demande par écrit à la coordonnée suivante :
( mettre une adresse mail ou adresse postale )
 <br/><br/>
                    <b>Droit d’auteur / copyright</b><br/><br/>

l’ensemble du contenu du présent site Internet, est la propriété de la société ISEP Paris, il est protégé par les lois en vigueur de la législation française sur la propriété intellectuelle.
<br/><br/>
...
<div class="container">
    <div class="search-box">
        ...
        style pour le couleur dans le input de la barre de recherche -->
...
<input class="mdp_mail_imput" type="text" name="email" placeholder="E-mail" >
        ...
        <form id="Inscription" class="Identification" method="post">
            ...
            <button type="submit" class="valider" onclick="window.location.href='#confirmation';">Valider </button>
        </form>
        ...
        <div id="confirmation" class="overlay">
            <div class="popup">
                <h2>
                    Merci de confirmer votre adresse mail en renseignant le code reçu par email.
                </h2>
                <a class="close" href="#">&times;</a>
                <span class="content">
                   <br/> <label>
<input class="confirmation_imput" type="number" name="code" placeholder="Code">
</label>
                </span>
