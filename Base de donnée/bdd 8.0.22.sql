...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Auto école` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Auto école` (
  ...
  UNIQUE INDEX `numéro de téléphone_UNIQUE` (`numero_de_telephone` ASC),
  UNIQUE INDEX `adresse mail_UNIQUE` (`adresse_mail` ASC))
ENGINE = InnoDB;
...
*/,
  ...
  UNIQUE INDEX `adresse mail_UNIQUE` (`adresse_mail` ASC),
  INDEX `fk_Personne_Auto école1_idx` (`cle_etrangere_auto_ecole` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Test` (
  ...
  UNIQUE INDEX `numéro du Test_UNIQUE` (`id_test` ASC),
  UNIQUE INDEX `nom du test_UNIQUE` (`nom_du_test` ASC),
...
-- Table `mydb`.`Capteurs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Capteurs` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Capteurs` (
  `id_Capteur` INT NOT NULL,
  `nom du capteur` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`id_Capteur`),
  UNIQUE INDEX `numéro du Capteur_UNIQUE` (`id_Capteur` ASC))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`FAQ Réponse` ;

CREATE TABLE IF NOT EXISTS `mydb`.`FAQ Réponse` (
  `id_reponse` INT NOT NULL,
  `reponse` VARCHAR(200) NOT NULL,
  PRIMARY KEY (`id_reponse`),
  UNIQUE INDEX `numéro de la réponse_UNIQUE` (`id_reponse` ASC))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`FAQ Question` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`FAQ Question` (
  ...
  UNIQUE INDEX `numéro de la question_UNIQUE` (`id_question` ASC),
  INDEX `fk_FAQ Question_FAQ Réponse1_idx` (`cle_etrangere_faq_reponse` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Résultats` (
  ...
  UNIQUE INDEX `nom du test_UNIQUE` (`type` ASC),
  INDEX `fk_Résultats_Capteurs_idx` (`cle_etrangere_capteur` ASC),
  INDEX `fk_Résultats_Test1_idx` (`cle_etrangere_Test` ASC),
